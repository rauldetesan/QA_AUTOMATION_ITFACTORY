...
1. se deschide un browser (e.g. Chrome)
2. se tipareste in browser URL-ul dorit (e.g. www.google.com)
3. browser-ul numit si client face o cerere/request catre server (cere un serviciu)
...
1. FRONTEND = ceea ce vedem in browser (toate aspectele vizuale)
...
O pagina HTML foloseste anumite elemente cum ar fi TAG-urile, care ii spun browser-ului cum
...
**************************** SELENIUM WEB DRIVER **************************
 ...
 Selenium WebDriver conduce/manipuleaza un browser, așa cum ar face un utilizator real.
 ...
 - pentru a utiliza Chrome browser, avem nevoie sa instalam Chromium
